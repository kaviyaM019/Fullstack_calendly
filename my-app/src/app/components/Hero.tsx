...
export default function Hero() {
    ...
    return(
        ...
        <h1 className="text-5xl font-bold mb-6 leading-tight">
         Scheduling{' '}
         <span className={"text-blue-800 cool-underline"+(showLine ? 'show-underline' : '')}>
            made simple
         </span>
         <br/>
         for people like you
        ...
        <div className="mt-4 flex gap-4 justify-center">
            ...
            <Link href={'/'}className="border border-gray-800 rounded-full py-2 px-4 inline-flex gap-1 items-center text-gay-800">
            <Play size={16} />
